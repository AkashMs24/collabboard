...
[![Vercel](https://img.shields.io/badge/Vercel-Deployed-000000?style=for-the-badge&logo=vercel)](https://collabboard-kappa.vercel.app)
...
Think Linear or Jira, but built from scratch with a focus on engineering fundamentals: event-driven architecture, transactional database operations, and secure token-based authentication.
...
3. Set env vars: `DATABASE_URL`, `JWT_SECRET`, `JWT_REFRESH_SECRET`, `CLIENT_URL`, `NODE_ENV=production`
...
Built as a demonstration of production software engineering: real-time systems, event-driven architecture, secure JWT auth patterns, transactional database design, and scalable backend architecture.
 
> This is not a tutorial clone. Every architectural decision — from idempotency keys to optimistic UI to refresh token rotation — was made deliberately to reflect how production systems are actually built.
